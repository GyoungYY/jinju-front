    ...
    <div class="detail-container">
        <el-card class="box-card">
            <div slot="header" style="display:flex;">
                <img :src="jinjuDetail.photoUrl" alt=""
                     style="width: 40px;height: 40px;border-radius:20px;cursor:pointer;"
                     @click="gotoUserPage(jinjuDetail.userId)">
            ...
            <div style="color:#999;">
                ...
                <span :class="{'clicked': jinjuDetail.isCollect}" class="glyphicon glyphicon-star-empty"
                      style="float:right;cursor:pointer;" @click="collectClick(jinjuDetail.jinjuId)">
                ...
                <span :class="{'clicked': jinjuDetail.upOrDownVote === 2}" class="glyphicon glyphicon-thumbs-down"
                      style="float:right;padding-right:10px;cursor:pointer" @click="downVoteClick(jinjuDetail.jinjuId)">
                    <span style="padding:0 10px;">{{jinjuDetail.downVoteCount}}</span>
                </span>
                <span :class="{'clicked': jinjuDetail.upOrDownVote === 1}" class="glyphicon glyphicon-thumbs-up"
                      style="float:right;padding-right:10px;cursor:pointer" @click="upVoteClick(jinjuDetail.jinjuId)">
